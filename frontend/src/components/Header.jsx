        ...
        <header className="bg-gray-900 text-white py-4 shadow-md">
            <div className="flex flex-wrap justify-between items-center max-w-7xl mx-auto px-4">
                ...
                <div className="w-full md:w-auto flex justify-center md:justify-end mt-2 md:mt-0 space-x-2">
                    {isLoggedIn ? (
                        <a href="http://localhost:3000/logout/" className="text-white text-sm md:text-lg px-4 py-2 md:px-6 md:py-3 rounded transition duration-300 hover:bg-purple-600">
                            <i className="fa-solid fa-right-from-bracket mr-2"></i> Logout
                        </a>
                    ) : (
                        <>
                            <a href="http://localhost:3000/login/" className="text-white text-sm md:text-lg px-4 py-2 md:px-6 md:py-3 rounded transition duration-300 hover:bg-purple-600">
                                <i className="fa-solid fa-right-to-bracket mr-2"></i> Login
                            </a>
                            <a href="http://localhost:3000/register/" className="text-white text-sm md:text-lg px-4 py-2 md:px-6 md:py-3 rounded transition duration-300 hover:bg-purple-600">
