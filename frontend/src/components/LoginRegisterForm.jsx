    ...
    return (
        <div className="bg-gray-800 min-h-screen flex items-center justify-center">
            <form onSubmit={handleSubmit} className="max-w-md w-full p-6 bg-gray-900 rounded-lg shadow-md">
                ...
                <input
                    className="form-input block w-full p-2 border border-gray-700 rounded mb-4 bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600"
                    type="text"
                    value={username}
                ...
                <button className="form-button w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-2 rounded hover:scale-105 transition duration-300 ease-in-out" type="submit">
                    {name}
                </button>
                {method === "login" && (
